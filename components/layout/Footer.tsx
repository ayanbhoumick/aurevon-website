      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
          ...
          <div className="flex flex-col gap-2 max-w-xs">
            <span className="text-text font-medium tracking-widest uppercase text-sm">
              Aurevon
            </span>
        ...
        <div className="mt-8 pt-6 border-t border-border flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <p className="text-muted text-xs">
            © {new Date().getFullYear()} Aurevon. All rights reserved.
          </p>
          <p className="text-muted text-xs">Greater Noida, India</p>
        </div>
      </div>
    </footer>
  );
